  ...
  const plans: ActivityPlan[] = [
    // ── Περιπέτειες στις Κυψέλες ────────────────────────────────────────────
    {
      ...
      data: {
        ...
        subtitle:
          "Ντυθείτε μελισσοκόμοι και ανοίξτε την κυψέλη — μια βιωματική εμπειρία για παιδιά από 3 ετών και ενήλικες.",
        ...
        details:
          "**Διάρκεια:** 45 λεπτά\n**Ηλικίες:** από 3 ετών και άνω. Οι ανήλικοι συμμετέχουν αποκλειστικά με συνοδεία γονέα ή κηδεμόνα, ο οποίος παραμένει μαζί τους σε όλη τη διάρκεια. Παρέχονται στολές μελισσοκόμου για όλους τους συμμετέχοντες και όλη η εμπειρία γίνεται υπό την καθοδήγηση έμπειρου μελισσοκόμου. Συνιστάται να φοράτε κλειστά παπούτσια και μακρύ παντελόνι.",
        ...
        age_label: "Από 3 ετών, με συνοδεία γονέα",
        ...
        meta_description:
          "Περιπέτειες στις κυψέλες: ντυθείτε μελισσοκόμοι και ανοίξτε την κυψέλη με τη βοήθεια του προσωπικού μας. Μια βιωματική εμπειρία για παιδιά από 3 ετών και ενήλικες — σε συνδυασμό με «Γνωρίζω τη Μέλισσα» ή κάποιο εργαστήρι, μόνο Σαββατοκύριακα, Ιούλιο–Νοέμβριο.",
        ...
        features: [
          ...
          {
            title: "Από 3 ετών & άνω",
            text: "Μια ασφαλής, καθοδηγούμενη εμπειρία για παιδιά από 3 ετών και ενήλικες — οι ανήλικοι πάντα με συνοδεία γονέα ή κηδεμόνα.",
          },
        ],
        policies: [
          {
          ...
          },
          {
            ...
            body: "Για αλλαγή ημερομηνίας ή ώρας, μπορείτε να καλέσετε στο [+357 99 130 092](tel:+35799130092). Οι αλλαγές πραγματοποιούνται κατόπιν διαθεσιμότητας.",
          },
        ],
        related_slugs: [
