  ...
  const plans: ActivityPlan[] = [
    // ── Περιπέτειες στις Κυψέλες ────────────────────────────────────────────
    {
      ...
      data: {
        ...
        age_label: "Από 2 ετών, με συνοδεία γονέα",
        ...
        meta_description:
          "Περιπέτειες στις κυψέλες: ντυθείτε μελισσοκόμοι και ανοίξτε την κυψέλη με τη βοήθεια του προσωπικού μας. Μια βιωματική εμπειρία για παιδιά από 2 ετών και ενήλικες — σε συνδυασμό με «Γνωρίζω τη Μέλισσα» ή κάποιο εργαστήρι, μόνο Σαββατοκύριακα, Ιούλιο–Νοέμβριο.",
