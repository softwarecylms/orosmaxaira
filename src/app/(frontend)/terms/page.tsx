...
const SECTIONS: LegalSection[] = [
  ...
  },
  {
    ...
    body: [
      ...
      'Για παραγγελίες ίσες ή άνω των €70 η αποστολή είναι δωρεάν. Οι χρόνοι παράδοσης εξαρτώνται από τον προορισμό και κυμαίνονται συνήθως σε 1–4 εργάσιμες ημέρες.',
    ],
  },
  {
    id: 'epistrofes',
