...
const SECTIONS: LegalSection[] = [
  ...
  },
  {
    ...
    body: [
      ...
      'Για παραγγελίες ίσες ή άνω των €70 με προορισμό την Κύπρο η αποστολή είναι δωρεάν. Για παραγγελίες προς Ελλάδα ισχύει πάντα το κόστος αποστολής των €7,00, ανεξαρτήτως αξίας. Οι χρόνοι παράδοσης εξαρτώνται από τον προορισμό και κυμαίνονται συνήθως σε 2–6 εργάσιμες ημέρες.',
    ],
  },
  {
    id: 'epistrofes',
