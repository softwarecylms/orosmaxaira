 ...
 * «Orders» carries a bubble with the orders still waiting to be fulfilled.
 */
...
export default async function MedusaLinks() {
  ...
  return (
    <div className="medusa-links">
      ...
      {LINKS.map((l) => (
        ...
        >
          <span className="medusa-links__name">
            {l.label}
            {'badge' in l ? <NewOrdersBadge initial={newOrders} /> : null}
          </span>
