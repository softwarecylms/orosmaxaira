...
/** A recent article as the teaser shows it. */
export type TeaserPost = { slug: string; title: string; image: string; excerpt: string }
...
export function BlogTeaserView({
  content: BLOG,
  posts,
}: {
  content: HomeContent['BLOG']
  /** The three most recent articles, newest first. */
  posts: TeaserPost[]
}) {
