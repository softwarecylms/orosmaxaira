...
import type { HomeContent, HoneyProduct } from './home-content'
...
export function DealOfMonthView({
  content: DEAL,
  products,
}: {
  content: HomeContent['DEAL']
  /** The cards as shown — the curated products with live shop prices.
   *  Defaults to the curated list with its stored prices. */
  products?: HoneyProduct[]
}) {
  const items = products ?? DEAL.products.slice(0, 5)
  return (
