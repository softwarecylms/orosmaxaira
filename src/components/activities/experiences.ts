...
export const EXPERIENCES: Record<string, ActivityExperienceData> = {
  ...
  'peripeteies-stis-kypseles': {
    ...
    metaDescription:
      'Περιπέτειες στις κυψέλες: ντυθείτε μελισσοκόμοι και ανοίξτε την κυψέλη με τη βοήθεια του προσωπικού μας. Μια βιωματική εμπειρία για παιδιά από 3 ετών και ενήλικες, διαθέσιμη Μάρτιο–Οκτώβριο.',
    hero: {
    ...
    intro: {
      ...
      body: [
        'Μια βιωματική εμπειρία, κατάλληλη για παιδιά και ενήλικες, όπου ο επισκέπτης ντύνεται με τη στολή του μελισσοκόμου και επισκέπτεται τις κυψέλες μας. Με τη βοήθεια του έμπειρου προσωπικού μας, ανοίγετε την κυψέλη και παρατηρείτε από κοντά την κοινωνία της μέλισσας. Η συμμετοχή επιτρέπεται από 3 ετών και άνω, με υποχρεωτική συνοδεία γονέα ή κηδεμόνα για τους ανηλίκους.',
