// AUTO-GENERATED EN editorial — English counterpart of product-details.generated.ts.
// One entry per handle present in GENERATED_PRODUCT_DETAILS, same shape/structure
// (same section count, same nutrition rows). Human-facing text is English —
// sourced from the live EN store (orosmaxaira.com/en) where available, otherwise
// translated faithfully from the Greek. Numeric values/units are kept identical.
// Do not hand-edit for translation drift — keep in sync with the Greek file.
...
export const GENERATED_PRODUCT_DETAILS_EN: Record<string, ShopProductDetail> = {
  "balance-care-gift-set": {
    ...
    "sections": [
      {
        "body": "Balance Care — Care for balanced and healthy skin"
      },
      {
        "body": "Includes:"
      },
      ...
      {
        "body": "Ideal for daily use, it leaves the skin hydrated, soft and naturally balanced."
      },
      {
      ...
      {
        "body": "The lips are particularly delicate and need daily care and protection."
      },
      {
        "body": "This natural balm offers hydration and nourishment, helping to repair dryness and keep the lips soft. Ideal for daily use, it provides instant relief and protection, especially during periods of intense dryness."
      },
      {
        "body": "Contains: pure organic beeswax, honey, propolis, royal jelly, calendula extract in organic olive oil, shea butter, almond oil, avocado oil, castor oil and sunflower oil."
      }
    ],
    "addons": [
  ...
  "nourish-care-gift-set": {
    ...
    "sections": [
      {
        "body": "Nourish Care — Deep, long-lasting nourishment and softness for the whole body"
      },
      {
        "body": "Includes:"
      },
  ...
  "everyday-care-duo-gift-set": {
    ...
    "sections": [
      {
        "body": "Everyday Care Duo — Everyday hydration and protection for hands and lips"
      },
      {
        "body": "Includes:"
      },
  ...
  "kiraloifi-gia-kyttaritida": {
    "description": "Formulated with a powerful blend of natural ingredients, this potent natural formula is designed to improve the texture and tone of the skin while promoting circulation and reducing the appearance of dimpling.",
    "gallery": [
  ...
  "ydromelo": {
    "description": "What is mead? Mead is an alcoholic beverage made by fermenting honey with water and yeast. The honey used, as well as the addition of fruits, spices and herbs, results in a wide variety of flavours and styles. The fermentation process can take anywhere from a few weeks to a few months, depending on the desired outcome.",
    "gallery": [
  ...
  "kiraloifi-gia-skasmena-cheria": {
    ...
    "sections": [
      {
        "body": "Your hands reveal your emotions. You use them every moment to work, to touch, to express yourself."
      },
      {
        "body": "Care for and love your very dry and cracked hands with the 100% natural beeswax salve with organic beeswax, honey, propolis and royal jelly."
      },
      {
        "body": "The choice of royal jelly as an ingredient for this hand cream is no coincidence. Its beneficial properties have been known for centuries, and the ancient Greeks referred to this special ingredient, said to grant immortality to the gods of Olympus."
      },
      {
  ...
  "fysiki-kiraloifi-gia-prosopo": {
    ...
    "sections": [
      {
        "body": "Your beauty lies in every expression. Your eyes, your mouth, your cheeks, your whole face have your own glow and spark."
      },
      {
        "body": "This 100% natural beeswax salve was made especially for the face, because we know that external stimuli are many and our stressful daily lives add to its strain and make it hard to protect."
      },
      {
        "body": "It is pure, offers hydration and is at the same time anti-ageing. It is made of organic beeswax, honey, propolis and royal jelly, precious ingredients that make up such a natural cosmetic. Hazelnut oil, apricot oil, macadamia, jojoba and essential oils of myrrh and frankincense offer properties of invaluable worth that you will surely feel with every touch. In addition, all the plant oils it contains come from organic cultivation."
      },
      {
        "body": "Gently apply a small amount of the salve over the entire face and, with a light massage, spread it so that it is absorbed. If your skin is very dry, trust this salve and feel your skin become like velvet once again."
      }
    ],
    "addons": [
      "nourish-care-gift-set",
  ...
  "krema-cherion-milk-amp-honey": {
    ...
    "sections": [
      {
        "body": "Hydration is everything for healthy skin. Hydrated hands mean healthy hands — soft to every touch, rested and, of course, radiant."
      },
      {
  ...
  "gyri-oros-machaira": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "body": "Pollen keeps unaltered in the freezer for up to one year after its production date. The correct way to store pollen is in the freezer at -18°C, from where it is consumed directly as it does not crystallise. Pollen can also be kept in the refrigerator for two months after its production date."
      }
    ],
    "addons": [
      "meigma-melioy-gyris-kai-vasilikoy-poltoy",
  ...
  "vasilikos-poltos-oros-machaira": {
    ...
    "sections": [
      {
        "body": "Like pollen and honey, royal jelly is one of the natural treasures produced by bees, with the difference that it is produced exclusively to feed the queen! It is the royal food par excellence, which serves to give the queen enough energy for rapid growth as well as for the production of thousands of eggs every day."
      },
      {
      ...
      {
        "heading": "Taste, colour, texture",
        "body": "Royal jelly has a creamy texture, a white to pale yellow colour and a slightly acidic taste."
      }
    ],
    "addons": [
      "meigma-melioy-gyris-kai-vasilikoy-poltoy",
  ...
  "kirithra-oros-machaira": {
    ...
    "sections": [
      {
        "heading": "How honeycomb is eaten",
        "body": "The simplest way is to cut off a small piece and consume it directly. You can also spread it on bread or add it to your oats or yoghurt."
      },
      {
        "heading": "How bees make honeycomb",
      ...
      },
      {
        ...
        "body": "Consuming honeycomb is safe, but it is best to start with small amounts. Some people have allergies to pollen, beeswax or honey. Once you start chewing the wax, you can then either swallow it or remove it. Honeycomb has no expiry date. However, it may crystallise since it contains honey."
      },
      {
        "heading": "Taste",
  ...
  "vamma-propolis-oros-machaira": {
    ...
    "sections": [
      ...
      {
        "body": "• People who are allergic to honey, bee pollen, royal jelly, conifers or poplars should not use propolis unless they are first examined by an allergist."
      },
      {
        "body": "Important: Propolis stains. It is very important to be careful when using it so that you do not ruin your clothes. Also, if you use a glass of water (for children), the glass may become stained."
      },
      {
  ...
  "meli-antheon-oros-machaira": {
    "description": "The rich flora of Cyprus allows us to produce a rich and unique blossom honey. Blossom honey consists mainly of nectar from orange blossom, myrtle, germander, wild lavender and other wild plants of Cyprus.",
    "variations": {
      "sizes": [
        {
          "label": "100g",
    ...
    "sections": [
      ...
      {
        "body": "Blossom honey is usually produced between April and August."
      }
    ],
    "addons": [
      "meli-me-foyntoykia",
  ...
  "avrasto-meli-antheon-oros-machaira": {
    "description": "Raw honey is considered the unprocessed honey that is extracted from the honeycomb without any processing and is provided to the consumer exactly as the bees produce it. Unlike honey that undergoes heat treatment and filtering, raw honey retains all of its yeasts and pollen grains, which are what give it its high nutritional value.",
    "variations": {
      "sizes": [
        {
          "label": "100g",
  ...
  "melissokeri": {
    "description": "Pure beeswax is one of the many products of the bee. The bee uses it to store honey inside. Beeswax can be used by people in a variety of homemade cosmetics. You can make hand creams, lotions, lip balm, hair products and many other natural and economical cosmetics. It has soothing and emollient properties, and when used on the skin it helps retain its moisture.",
    "gallery": [
    ...
    "sections": [
      ...
      {
        "body": "Oros Machaira beeswax is raw, economical and can be used to make candles, cosmetics, soaps, salves and other natural products. You can buy it online, as it is difficult to find in the supermarkets of Cyprus."
      }
    ],
    "addons": [
      "meigma-melioy-gyris-kai-vasilikoy-poltoy",
